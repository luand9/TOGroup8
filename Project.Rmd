...
Here, we can see that there are significantly more subscribers than customers. Additionally, the graph suggests that there is a relationship between temperature and citi bike usage, with the majority of rides occurring between 50 and 75 degrees for customers and subscribers. 
