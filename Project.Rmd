...
ggplot(data=bike_deficit, aes(x=bike_deficit$station, y=bike_deficit$deficit)) + geom_histogram(binwidth = 2.5,colour="grey",fill="lavender") + ggtitle("Histogram of Station Deficits in 2019 in NYC")
```
